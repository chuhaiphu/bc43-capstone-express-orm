...
import { getUserInfo, getSavedImages, getCreatedImages, saveImage, updateUserInfo, updateProfilePicture, changePassword, unsaveImage } from '../controllers/user.controller.js';
...
userRouter.delete("/unsave-image", middlewareTokenHandler, unsaveImage);
